...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FormDefinition.site'
        db.add_column('form_designer_formdefinition', 'site', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FormDefinition.site'
        db.delete_column('form_designer_formdefinition', 'site_id')
